...
* @see LinkedBag
******************************************************************************/
public class GameShowArrayBag<E> implements Cloneable
{
...
**/   
public GameShowArrayBag(int initialCapacity)
{
...
**/
public void addAll(GameShowArrayBag<E> addend)
{
...
**/ 
@SuppressWarnings("unchecked")
public GameShowArrayBag<E> clone( )
{  // Clone an ArrayBag object.
   GameShowArrayBag<E> answer;
   
   try
   {
      answer = (GameShowArrayBag<E>) super.clone( );
   }
...
*   a different bag implementation.
**/   
public static <E> GameShowArrayBag<E> union(GameShowArrayBag<E> b1, GameShowArrayBag<E> b2)
{
   // If either b1 or b2 is null, then a NullPointerException is thrown. 
   // In the case that the total number of items is beyond
   // Integer.MAX_VALUE, there will be an arithmetic overflow and
   // the bag will fail.   
   GameShowArrayBag<E> answer = new GameShowArrayBag<E>(b1.getCapacity( ) + b2.getCapacity( ));
